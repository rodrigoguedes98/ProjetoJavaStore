...
public class DeletarCliente extends javax.swing.JFrame {
            ...
            if(check==1){
                while (res.next()){
                    ...
                    if(busca.equals(login)){
                        ...
                        jLabel4RgRs.setText(res.getString("razaoSocial_Rg"));
                        jLabelEndereco.setText(res.getString("endereco"));
                        jLabelLogin.setText(res.getString("login"));
                        jLabelId.setText(res.getString("idcliente"));                   
                    }
                }
            }else if (check == 2){
                while (res.next()){
    ...
    private void jButtonDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeletarActionPerformed
        ...
        try {
            Connection con = ConexaoMySQL.getInstance().getConnection();
            String cmd = "delete from pessoa where idcliente = '"+jLabelId.getText()+"'";
